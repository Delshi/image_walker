...
**ImageWalker** — это гибкий и расширяемый инструмент для автоматической сортировки файлов по категориям на основе их метаданных: содержимого, типа, расширения, разрешения, размера, даты и других параметров. Поддерживает изображения, видео, аудио, документы и любые другие форматы.
